...
export FZF_DEFAULT_OPTS="--layout=reverse --color=fg:${fg},bg:${bg},hl:${purple},fg+:${fg},bg+:${bg_highlight},hl+:${purple},info:${blue},prompt:${cyan},pointer:${cyan},marker:${cyan},spinner:${cyan},header:${cyan}"


## Git integration to use fzf for fuzzy searching through git objects. See: https://github.com/junegunn/fzf-git.sh
